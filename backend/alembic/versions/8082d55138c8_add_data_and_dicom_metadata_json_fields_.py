...
def upgrade() -> None:
    ...
    op.add_column('annotations', sa.Column(
        'data', sa.JSON(), nullable=True, default={}))
    op.add_column('annotations', sa.Column(
        'dicom_metadata', sa.JSON(), nullable=True))
    op.drop_column('annotations', 'bounding_boxes')
    op.drop_constraint('uq_images_orthanc_project_folder',
                       'images', type_='unique')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_unique_constraint('uq_images_orthanc_project_folder', 'images', [
                                'orthanc_id', 'project_id', 'folder_id'])
    op.add_column('annotations', sa.Column('bounding_boxes', postgresql.JSON(
